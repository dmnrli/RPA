...
# 以下两个font的路径一定要记得更换成你们的字体路径啊
# 收到好多人的私信说报错都是这个地方
# 我当时写这个代码的时候用的是Ubuntu写的
# window的字体库在`C:/Windows/Fonts`里面
# 月，日，周，时，分，秒字体
font1 = pygame.font.Font("C:/Windows/Fonts/simhei.ttf", 11)
# 年字体
font2 = pygame.font.Font("C:/Windows/Fonts/simhei.ttf", 15)
# 时钟中心
pos_x = 400
pos_y = 330
# 年月日周时分秒对应中文字符
...
while True:
    ...
    screen.fill("grey11")
    # 绘制一条表明当前日期时间的红线
    pygame.draw.line(screen, color="red", start_pos=(380, pos_y+18), end_pos=(770, pos_y+18), width=2)
    # 获取当前年份
...
#————————————————
#原文链接：https://blog.csdn.net/weixin_41812858/article/details/122029239